<%-- 
    ...
    Created on : Sep 18, 2018, 6:47:36 PM
    Author     : Bajaja
--%>
...
<head>
    ...
    <script type="text/javascript">
        function myalert(){
            alert("Your Order Item has been Cancelled");
        }
    </script>
<meta charset="utf-8">
...
<li><a href="#"><%= session.getAttribute("Custname")%> </a>
    <ul>
        ...
        <div>
            ...
            <p>If you want to cancel your order </p>
            <p>Click On Cancel Button</p>
            <center><input type="number" name="cancel" placeholder="Enter Order Number"/></center>
            <center><input type="submit" value="CANCEL ORDER" onclick="myalert()"/></center>
            </form>
        </div>
