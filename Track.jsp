<%-- 
    Document   : Track
    Created on : Sep 16, 2018, 6:24:07 PM
    Author     : Bajaja
--%>
...
<title>Track Order Detail Search box</title>
</head>
...
<li><a href="#"><%= session.getAttribute("Custname")%> </a>
    <ul>
        ...
        <li><a href="ViewOrder.jsp">WISHLIST</a></li>
...
<div class="search-box">
        ...
        <input class="search-txt" type="text" name="track" placeholder="Search..."/>
        <a class="search-btn" >
