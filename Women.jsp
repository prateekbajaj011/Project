<%-- 
    Document   : Women
    Created on : Aug 23, 2018, 6:19:25 PM
    Author     : Bajaja
--%>
...
<div class="product">
		<div class="container">
			<div class="product_section_title">WOMEN'S COLLECTION</div>
			...
			<div class="product_one">
				...
				<div class="product_text">
					<h4>True Diamond and Ceramic</h4>
				</div>
				...
				<div class="product_desc">
					<b>AB Collection Ceramic-01 - For Women's</b>
				</div>
			...
			<div class="product_one product_two">
				...
				<div class="product_desc">
					<b>AB Collection Ceramic-02 - For Women's</b> 
				</div>
				<div class="product_price">
					<div class="price">
						₹999.00
			...
			<div class="product_one product_three">
				...
				<div class="product_desc">
					<b>AB Collection Ceramic-03 - For Women's</b>
				</div>
				<div class="product_price">
					<div class="price">
						₹999.00
			...
			<div class="product_one product_four">
				...
				<div class="product_desc">
					<b>AB Collection Ceramic-04 - For Women's</b>
				</div>
				<div class="product_price">
					<div class="price">
						₹999.00
